...
const Login= () => {
  ...
  const sumbitHandler =(e)=>{
    ...
    .then( async res=>{
      ...
      const getuser = await getDoc(doc(db,"users",userId))
      .then((userResp)=>{
    ...
    <div className="h-screen font-popins py-20 px-2">
      <div className="max-w-[400px]  border m-auto bg-white px-3 flex flex-col gap-5 py-5 rounded-sm shadow-lg">
        ...
        <div className="w-full">
          <button className="bg-blue-600 from-blue-600 to-purple-600 w-full py-2 text-white font-semibold">
            Login 
          </button>
        </div>
        ...
        <div className="flex justify-center flex-col sm:flex-row">
          ...
          <NavLink to="/sign-up" className="text-blue-700 cursor-pointer text-center hover:text-purple-600">
            sign up Now
          </NavLink>
        </div>
